  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        MessageFormat.format(
            "Average population affected by drought: {0}", averagePopulationAffectedByDrought));

    System.out.println(
        MessageFormat.format(
            "Variances affected population droughts: {0}", varianceAffectedPopulationDroughts));
  }
}
